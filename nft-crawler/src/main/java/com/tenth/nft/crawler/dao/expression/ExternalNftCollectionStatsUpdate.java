 ...
 */
public class ExternalNftCollectionStatsUpdate extends SimpleUpdate {
    ...
    public static class Builder{
        ...
        private ExternalNftCollectionStatsUpdate update = new ExternalNftCollectionStatsUpdate();
        ...
        public ExternalNftCollectionStatsUpdate build(){
            return update;
        }
