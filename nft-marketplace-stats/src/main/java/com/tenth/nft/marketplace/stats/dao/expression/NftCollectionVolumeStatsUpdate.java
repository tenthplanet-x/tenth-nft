 ...
 */
public class NftCollectionVolumeStatsUpdate extends SimpleUpdate {
    ...
    public static class Builder{
        ...
        private NftCollectionVolumeStatsUpdate update = new NftCollectionVolumeStatsUpdate();
        ...
        public NftCollectionVolumeStatsUpdate build(){
            return update;
        }
