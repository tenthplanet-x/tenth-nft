 ...
 */
public class ExternalNftCollectionUpdate extends SimpleUpdate {
    ...
    public static class Builder{
        ...
        private ExternalNftCollectionUpdate update = new ExternalNftCollectionUpdate();
        ...
        public ExternalNftCollectionUpdate build(){
            return update;
        }
