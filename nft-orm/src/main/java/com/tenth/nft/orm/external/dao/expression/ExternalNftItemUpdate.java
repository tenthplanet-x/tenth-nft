 ...
 */
public class ExternalNftItemUpdate extends SimpleUpdate {
    ...
    public static class Builder{
        ...
        private ExternalNftItemUpdate update = new ExternalNftItemUpdate();
        ...
        public ExternalNftItemUpdate build(){
            return update;
        }
