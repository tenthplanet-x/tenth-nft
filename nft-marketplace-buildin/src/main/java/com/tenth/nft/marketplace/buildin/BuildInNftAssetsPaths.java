package com.tenth.nft.marketplace.buildin;
...
public class BuildInNftAssetsPaths {
    ...
    public static final String NFT_LISTING_BUY_STATUS = "/nft/exchange/buy/status/buildin";

    public static final String OFFER_LIST = "/nft/exchange/offer/list/buildin";
    public static final String OFFER_CREATE = "/nft/exchange/offer/create/buildin";
    public static final String OFFER_CANCEL = "/nft/exchange/offer/cancel/buildin";
    public static final String OFFER_ACCEPT = "/nft/exchange/offer/accept/buildin";
    public static final String OFFER_ACCEPT_STATUS = "/nft/exchange/offer/accept/status/buildin";
